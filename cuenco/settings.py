"""
Django settings for cuenco project.
...
SECRET_KEY = '33-03fd+9*@har%iwzb-o7k%m00oxjl5n&i328+hr#$kqddp5z'
...
WSGI_APPLICATION = 'cuenco.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            'read_default_file': os.path.join(BASE_DIR, 'cuenco/database.cfg'),
        },
    }
}
